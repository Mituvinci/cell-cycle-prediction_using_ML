#!/usr/bin/env bash
################################################################################
# Process PBMC Healthy Human Dataset
...
echo "================================================================================"
echo "PROCESSING: PBMC Healthy Human Dataset"
echo "================================================================================"
echo ""

# Configuration
MAPPING_FILE="phase_mappings_pbmc_human.yaml"
DATA_DIR="/users/ha00014/Halimas_projects/DeepLearning_CellCyelPhaseDetection_scRNASeq/data/Training_data"
REASSIGNED_DIR="./reassigned_predictions_human"
FINAL_DIR="./final_training_data_human"
MIN_AGREEMENT=2
...
echo ""
echo "================================================================================"
echo "SUCCESS! PBMC Human Training Data Ready"
echo "================================================================================"
echo ""
echo "Final training data: $FINAL_DIR/pbmc_human_consensus.csv"
echo ""
...
echo "    --data $FINAL_DIR/pbmc_human_consensus.csv \\"
echo "    --trials 50 \\"
echo "    --cv 5 \\"
echo "    --output results_pbmc_dnn3"
echo ""
