#!/bin/bash
################################################################################
# STEP 1: Generate Contingency Tables + Heatmaps for Nestorova dataset
...
DATA_DIR="$BASE_DIR/data/Nestorova_mouse_new_training_data"
OUTPUT_DIR="$BASE_DIR/cell_cycle_prediction/1_consensus_labeling/results/nestorova"
...
SEURAT="$DATA_DIR/seurat_nestorova_cc_phases.csv"
TRICYCLE="$DATA_DIR/tricycle_nestorova.csv"
CCAFV2="$DATA_DIR/ccAFV2_nestorova.csv"
REVELIO="$DATA_DIR/revelio_nestorova.csv"

DATASET_NAME="nestorova"
...
echo "================================================================================"
echo "NESTOROVA - STEP 1: ANALYZE (Contingency Tables + Heatmaps)"
echo "================================================================================"
...
echo "    - heatmap_seurat_vs_tricycle_nestorova.png"
echo "    - heatmap_seurat_vs_ccafv2_nestorova.png"
echo "    - heatmap_seurat_vs_revelio_nestorova.png"
echo ""
