#!/bin/bash
################################################################################
# STEP 1: Generate Contingency Tables + Heatmaps for SUP-B15 dataset
...
OUTPUT_DIR="$BASE_DIR/1_consensus_labeling/results/sup"
...
SEURAT="$OUTPUT_DIR/seurat_2_GD444_21136_Hu_Sup_Parental_cc_phases.csv"
TRICYCLE="$OUTPUT_DIR/tricycle_2_GD444_21136_Hu_Sup_Parental.csv"
CCAFV2="$OUTPUT_DIR/ccAFV2_2_GD444_21136_Hu_Sup_Parental.csv"
REVELIO="$OUTPUT_DIR/revelio_2_GD444_21136_Hu_Sup_Parental.csv"
...
echo "================================================================================"
echo "SUP-B15 - STEP 1: ANALYZE (Contingency Tables + Heatmaps)"
echo "================================================================================"
...
echo "    - heatmap_seurat_vs_tricycle_sup.png"
echo "    - heatmap_seurat_vs_ccafv2_sup.png"
echo "    - heatmap_seurat_vs_revelio_sup.png"
echo ""
