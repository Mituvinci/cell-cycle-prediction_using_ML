#!/usr/bin/env bash
# FINAL TRAINING - ALL DEEP LEARNING MODELS
...
for i in "${!DATASETS[@]}"; do
  ...
  for MODEL in "${MODELS[@]}"; do
    ...
    sbatch --export=ALL,TRAINING_SCRIPT="../2_model_training/train_deep_learning.py",TRAINING_ARGS="$TRAINING_ARGS" --job-name="DL_${DATASET}_${MODEL}" ../scripts/train_model_generic.slurm
    sleep 1
  done
done

echo "================================================================================"
echo "SUBMITTED: 3 datasets × 5 DL models = 15 jobs"
echo "================================================================================"
