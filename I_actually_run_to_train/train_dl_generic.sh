#!/usr/bin/env bash
################################################################################
# Generic Deep Learning Training Script
# Usage: bash train_dl_generic.sh <dataset_name> <training_data_path> <gene_list_path> <scaling_method> [feature_selection_method]
# Example: bash train_dl_generic.sh reh 1_consensus_labeling/assign/final_training_data_reh/reh_training_data.csv gene_lists/reh_3benchmark_sup.txt robust
# Example: bash train_dl_generic.sh reh 1_consensus_labeling/assign/final_training_data_reh/reh_training_data.csv gene_lists/reh_3benchmark_sup.txt robust SelectKBest
################################################################################
...
echo "================================================================================"
echo "TRAINING ALL DEEP LEARNING MODELS ON ${DATASET_NAME^^} DATA"
echo "================================================================================"
echo ""
...
TRAINING_ARGS="$TRAINING_ARGS" \
           --job-name="dl_${DATASET_NAME}_${MODEL}" \
