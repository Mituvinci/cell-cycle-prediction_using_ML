#!/usr/bin/env bash
################################################################################
# Concatenated 4 Datasets: Evaluation -> Consolidation -> Benchmark Results Pipeline
#
...
#         -> creates results/double/consolidated_concate_4ds_all.csv
# STEP_3: Generate final benchmark results + Top-3 ensemble + plots
#         -> outputs to 5_visualization/heatmap_barplot_lineplots_csv/nft_concate_4ds_all/
#
# Usage:
#   bash run_concate_4ds_pipeline.sh            # run all 3 steps
#   bash run_concate_4ds_pipeline.sh --step 1   # run only STEP_1
#   bash run_concate_4ds_pipeline.sh --step 2   # run only STEP_2
#   bash run_concate_4ds_pipeline.sh --step 3   # run only STEP_3
################################################################################

BASE_DIR="/users/ha00014/Halimas_projects/DeepLearning_CellCyelPhaseDetection_scRNASeq/cell_cycle_prediction"
cd "$BASE_DIR"
method_is="simple"
MODEL_BASE="models/final_best/concate_4ds_all"
CONSOLIDATED_OUTPUT="results/$method_is/consolidated_concate_4ds_all.csv"
...
echo "================================================================================"
echo "STEP_1: BENCHMARK EVALUATION (Concatenated 4 Datasets)"
echo "================================================================================"
...
python 5_visualization/5_plot_tool_comparison_barplot.py --training-dataset nft_concate_4ds_all
...
echo "================================================================================"
echo "STEP_3 DONE"
echo "Results: 5_visualization/heatmap_barplot_lineplots_csv/nft_concate_4ds_all/"
echo "================================================================================"
