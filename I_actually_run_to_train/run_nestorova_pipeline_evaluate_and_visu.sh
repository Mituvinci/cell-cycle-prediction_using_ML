#!/usr/bin/env bash
################################################################################
# Nestorova: Evaluation -> Consolidation -> Benchmark Results Pipeline
#
# STEP_1: Evaluate all trained Nestorova models on 4 benchmarks
#         -> creates *_details_benchmark.csv in each model subdirectory
# STEP_2: Consolidate training + benchmark metrics into one CSV
#         -> creates results/double/consolidated_nestorova.csv
# STEP_3: Generate final benchmark results + Top-3 ensemble + plots
#         -> outputs to 5_visualization/heatmap_barplot_lineplots_csv/nft_nestorova/
#
# Usage:
#   bash run_nestorova_pipeline.sh            # run all 3 steps
#   bash run_nestorova_pipeline.sh --step 1   # run only STEP_1
#   bash run_nestorova_pipeline.sh --step 2   # run only STEP_2
#   bash run_nestorova_pipeline.sh --step 3   # run only STEP_3
################################################################################

BASE_DIR="/users/ha00014/Halimas_projects/DeepLearning_CellCyelPhaseDetection_scRNASeq/cell_cycle_prediction"
cd "$BASE_DIR"

MODEL_BASE="models/nestorova"
CONSOLIDATED_OUTPUT="results/double/consolidated_nestorova.csv"
...
echo "================================================================================"
echo "STEP_1: BENCHMARK EVALUATION"
echo "================================================================================"
echo "Model directory : $MODEL_BASE"
echo "Benchmarks      : $BENCHMARKS"
echo "Scaling method  : double"
echo "================================================================================"
echo ""
...
python 5_visualization/5_plot_tool_comparison_barplot.py --training-dataset nft_nestorova
...
echo "================================================================================"
echo "STEP_3 DONE"
echo "Results: 5_visualization/heatmap_barplot_lineplots_csv/nft_nestorova/"
echo "================================================================================"
