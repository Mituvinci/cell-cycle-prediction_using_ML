#!/usr/bin/env bash
# Train TML models on GSE75748 + Nestorova WITH SELECTKBEST (K=300)
...
echo "================================================================================"
echo "Training TML models on GSE75748 + Nestorova"
...
for MODEL in "${MODELS[@]}"; do
  ...
  sbatch --export=ALL,TRAINING_SCRIPT="../2_model_training/train_traditional_ml.py",TRAINING_ARGS="$TRAINING_ARGS" --job-name="TML_K300_GSE75748Nest_${MODEL}" ../scripts/train_model_generic.slurm
  sleep 1
done

echo "================================================================================"
echo "SUBMITTED: 4 TML jobs (with SelectKBest k=300)"
echo "================================================================================"
