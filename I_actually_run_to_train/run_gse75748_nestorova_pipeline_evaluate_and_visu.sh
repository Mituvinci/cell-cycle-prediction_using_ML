#!/usr/bin/env bash
################################################################################
# GSE75748 + Nestorova: Evaluation -> Consolidation -> Benchmark Results Pipeline
#
...
#         -> creates results/simple/consolidated_gse75748_nestorova.csv
# STEP_3: Generate final benchmark results + Top-3 ensemble + plots
#         -> outputs to 5_visualization/heatmap_barplot_lineplots_csv/nft_gse75748_nestorova/
#
# Usage:
#   bash run_gse75748_nestorova_pipeline_evaluate_and_visu.sh            # run all 3 steps
#   bash run_gse75748_nestorova_pipeline_evaluate_and_visu.sh --step 1   # run only STEP_1
#   bash run_gse75748_nestorova_pipeline_evaluate_and_visu.sh --step 2   # run only STEP_2
#   bash run_gse75748_nestorova_pipeline_evaluate_and_visu.sh --step 3   # run only STEP_3
################################################################################

BASE_DIR="/users/ha00014/Halimas_projects/DeepLearning_CellCyelPhaseDetection_scRNASeq/cell_cycle_prediction"
cd "$BASE_DIR"
method_is="simple"
MODEL_BASE="models/final_best/gse75748_nestorova"
CONSOLIDATED_OUTPUT="results/$method_is/consolidated_gse75748_nestorova.csv"
...
echo "================================================================================"
echo "STEP_1: BENCHMARK EVALUATION (GSE75748 + Nestorova)"
echo "================================================================================"
...
python 5_visualization/5_plot_tool_comparison_barplot.py --training-dataset nft_gse75748_nestorova
...
echo "================================================================================"
echo "STEP_3 DONE"
echo "Results: 5_visualization/heatmap_barplot_lineplots_csv/nft_gse75748_nestorova/"
echo "================================================================================"
