...
def evaluate_on_benchmark(model, scaler, label_encoder, selected_features, model_dir, dataset_name, is_tml=False, scaling_method='simple'):
    ...
    Args:
        ...
        scaling_method: 'simple' (1x), 'double' (2x), or 'triple' (3x experimental)
...
def main():
    ...
    parser.add_argument(
        ...
        default='simple',
        help='Scaling method for benchmarks: simple (1x scaling), double (2x scaling for domain adaptation), or triple (3x scaling - experimental). Default: simple'
    )
